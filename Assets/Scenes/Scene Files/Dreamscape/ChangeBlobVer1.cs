...
public class ChangeBlobVer1 : MonoBehaviour {
	...
	void Start () {
		...
		//stores the material of the blob
		blobMaterial = GetComponent<Renderer>().material;
	...
	IEnumerator changeColor () {
		...
		for (t = 0.0f; t < duration; t+= Time.deltaTime) {
			GetComponent<Renderer>().material.color = 
				Color.Lerp(arrayOfColors[firstRandomInt], arrayOfColors[secondRandomInt], t/ duration);
